@ManagerEditBusinessCategoriesSimpleDocumentWarePage = React.createClass
  render: ->
    <div className="manager-edit-business-categories-simple-document-ware-page">
      <ManagerEditBusinessCategoriesSimpleDocumentWarePage.Form data={@props.data} />
    </div>
  ...
  statics:
    Form: React.createClass
      ...
      render: ->
        ...
        checked_ids = []
        for x in @props.data.simple_document_ware.business_categories
