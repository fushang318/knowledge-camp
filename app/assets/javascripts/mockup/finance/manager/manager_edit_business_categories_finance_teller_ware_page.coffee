@ManagerEditBusinessCategoriesFinanceTellerWarePage = React.createClass
  render: ->
    <div className="manager-edit-business-categories-finance-teller-ware-page">
      <ManagerEditBusinessCategoriesFinanceTellerWarePage.Form data={@props.data} />
    </div>
  ...
  statics:
    Form: React.createClass
      ...
      render: ->
        ...
        checked_ids = []
        for x in @props.data.finance_teller_ware.business_categories
